...
function Intro({ onDone }) {
  ...
  return (
    <div style={{ minHeight:"100vh",background:"#fff",display:"flex",alignItems:"center",justifyContent:"center",flexDirection:"column" }}>
      ...
      <img src={img("public/epsi-logo.png")} alt="EPSI" style={{ height:"70px",marginBottom:"32px",animation:"gp 2s ease-in-out infinite" }} />
  ...
  return (
    <div>
      <div style={{ textAlign:"center",padding:"80px 0 48px" }}>
        <img src={img("public/epsi-logo.png")} alt="EPSI" style={{ height:"70px",marginBottom:"32px" }} />
      ...
      <Card style={{ maxWidth:"500px",margin:"0 auto 48px",textAlign:"center" }}>
        ...
        <div style={{ display:"flex",justifyContent:"center",gap:"40px" }}>
          {[{name:"Hodari Bigwi",photo:img("public/photoHodari.jpg")},{name:"Téo Debay",photo:img("/photoTeo.jpg")}].map((p,i) => (
